...
JSC.SafeObjects = {
	...
	doorObj  = { ModelName = JSC.SafeModels.Door,  Pos 	= vector3(   0.0,   0.0,    0.0 ), Heading = 150.0, Rot = vector3(0.0,   0.0,   0.0), 		Frozen = true  },
	...
	gunAObj  = { ModelName = JSC.SafeModels.GunA,  Pos 	= vector3(   0.0,  0.45,   0.20 ), Heading = 0.0,   Rot = vector3(45.0, 45.0, 270.0), 		Frozen = false },
	cashBObj = { ModelName = JSC.SafeModels.WeedA, Pos 	= vector3( -0.45,  0.30,   0.75 ), Heading = 0.0,   Rot = vector3(0.0,   0.0,   0.0), 		Frozen = false },
	cashBObj = { ModelName = JSC.SafeModels.WeedB, Pos 	= vector3( -0.35,  0.30,   0.75 ), Heading = 0.0,   Rot = vector3(0.0,   0.0,   0.0), 		Frozen = false },
	...
	methCObj = { ModelName = JSC.SafeModels.MethC, Pos 	= vector3( -0.55,  0.25,   0.75 ), Heading = 0.0,   Rot = vector3(0.0,   0.0,   0.0), 		Frozen = false },
